...
do
    ...
    scp -i "~/.ssh/$KEY_PAIR.pem" -o "StrictHostKeyChecking=no" -o "UserKnownHostsFile=/dev/null" ubuntu@${BROKER_IP}:/rabbitmq/var/log/rabbitmq/rabbit@rabbitmq${NODE}.log $TARGET_DIR/rabbit@rabbitmq${NODE}.log
done