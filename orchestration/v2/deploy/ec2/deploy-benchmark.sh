...
scp -i "~/.ssh/${KEY_PAIR}.pem" -o "StrictHostKeyChecking=no" -o "UserKnownHostsFile=/dev/null" -r "../../configuration/workloads/topologies" ubuntu@$LOADGEN_IP:.
scp -i "~/.ssh/${KEY_PAIR}.pem" -o "StrictHostKeyChecking=no" -o "UserKnownHostsFile=/dev/null" -r "../../configuration/workloads/policies" ubuntu@$LOADGEN_IP:.
scp -i "~/.ssh/${KEY_PAIR}.pem" -o "StrictHostKeyChecking=no" -o "UserKnownHostsFile=/dev/null" -r "../../../../benchmark/src/main/resources/logback.xml" ubuntu@$LOADGEN_IP:.
