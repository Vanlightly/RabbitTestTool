...
public class K8sDeployer implements Deployer {
    ...
    public K8sDeployer(String runTag,
        ...
        if(!scriptDir.exists())
            throw new InvalidInputException("The script directory '" + k8sMeta.getDeployScriptsDir() + "' does not exist");
    }
    ...
    public void deploySystem() {
        ...
        try {
            ...
            if(!system.getRabbitmq().rebootBetweenBenchmarks()) {
                redeployRabbitMQ(system.getRabbitmqConfig());
            }
        } catch(Exception e) {
    ...
    private boolean deployOnManagedK8s() {
        String logPrefix = "Deployment of k8s cluster for system: " + system.getName();
    ...
    public void applyNewConfiguration(RabbitMQConfiguration brokerConfiguration) {
        redeployRabbitMQ(brokerConfiguration);
    }



//    private void applyNewConfiguration2(RabbitMQConfiguration brokerConfiguration) {
...
//    }
    ...
    private void redeployRabbitMQ(RabbitMQConfiguration brokerConfiguration) {
        String logPrefix = "Deployment of RabbitMQ for system: " + system.getName();
    ...
    public void teardown() {
        ...
        List<String> args = Arrays.asList("bash",
                system.getK8sEngineStr() + "/delete-cluster.sh",
